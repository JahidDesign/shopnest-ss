...
const { getGlosoryProductsCollection } = require("../db");
...
// CRUD is same as hotproducts.js, but using getGlosoryProductsCollection()
router.get("/", async (req, res) => {
  try {
    const { minRating, sortBy, order } = req.query;
    const collection = await getGlosoryProductsCollection();
    const query = {};
...
router.post("/", async (req, res) => {
  ...
  try {
    const collection = await getWomenProductsCollection();
