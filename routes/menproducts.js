...
const { getMenProductsCollection } = require("../db");
...
// CRUD same as newproducts.js but using getMenProductsCollection()
router.get("/", async (req, res) => {
  try {
    const { minRating, sortBy, order } = req.query;
    const collection = await getMenProductsCollection();
    const query = {};
