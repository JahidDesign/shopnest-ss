...
const { getOurInsurancePoliceCollection } = require("../db");
...
router.get("/quote", async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      estimatedPremium: { monthly: monthlyPremium.toFixed(2), annual: annualPremium.toFixed(2) },
      quotes: { page, limit, total: totalQuotes, totalPages: Math.ceil(totalQuotes / limit), data: quotes },
